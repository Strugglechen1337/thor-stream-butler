<div align="center">
  ...
  <p>
    ...
    ·
    <a href="https://github.com/Strugglechen1337/thor-stream-butler/releases/tag/v0.8.0-alpha.1"><strong>Download v0.8.0-alpha.1</strong></a>
    ·
...
[v0.8.0-alpha.1](https://github.com/Strugglechen1337/thor-stream-butler/releases/tag/v0.8.0-alpha.1)
...
> **Alpha warning:** v0.8.0-alpha.1 is signed with the permanent Thor Stream
...
> if needed, uninstall the old alpha, and then install v0.8.0-alpha.1 —
...
> **Alpha-Warnung:** v0.8.0-alpha.1 ist mit dem dauerhaften
...
> deinstalliere die alte Alpha und installiere danach v0.8.0-alpha.1 — die
